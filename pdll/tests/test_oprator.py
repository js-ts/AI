...
class Testing(unittest.TestCase):
    ...
    def test_ops(self, ):
        ...
        numpy.testing.assert_almost_equal(v_a.grad.numpy(), t_a.grad.data.numpy(), decimal=4)
        numpy.testing.assert_almost_equal(v_b.grad.numpy(), t_b.grad.data.numpy(), decimal=4)
    ...
    def test_stats(self, ):
        ...
        numpy.testing.assert_almost_equal(v_c.data.numpy(), t_c.data.numpy(), decimal=2)
        numpy.testing.assert_almost_equal(v_a.grad.numpy(), t_a.grad.data.numpy(), decimal=2)
    ...
    def test_shape(self, ):
        ...
        numpy.testing.assert_almost_equal(v1.data.numpy(), t1.data.numpy(), decimal=4)
        numpy.testing.assert_almost_equal(v.grad.numpy(), t.grad.data.numpy(), decimal=4)
